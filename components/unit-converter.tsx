  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-900">
      ...
      <div className="max-w-md w-full p-6 bg-card rounded-lg shadow-lg">
        <h1 className="text-2xl text-black font-bold mb-1 text-center">Unit Converter</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="space-y-2">
            <Label htmlFor="input-unit" className="text-black">From</Label>
          ...
          <div className="space-y-2">
            <Label htmlFor="output-unit" className="text-black" >To</Label>
          ...
          <div className="space-y-2 col-span-2">
            <Label htmlFor="input-value" className="text-black">Value</Label>
            <Input
              id="input-value"
              type="number"
